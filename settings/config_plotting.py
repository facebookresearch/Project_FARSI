...
ignore_file_names = ["README.md", "figures", "cross_workloads", "single_workload", "3D", "budget_optimality", "panda_study", "pie_chart"]
#plot_list = ["cross_workloads", "single_workload","plot_3d", "pandas_plots", "budget_optimality"]
plot_list = ["pie_char"]#"cross_workloads", "single_workload"]
